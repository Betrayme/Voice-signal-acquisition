...
/*
 * 功能描述：
 *     通过定时器0触发DMA数据传输，通过DMA通道1将DMARAML5中的数据传输至DMARAML4。
 *
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 DMA_RAM_TO_RAM Demo application.\r\n\r\n", -1);
...
// Configure DMA Channel
	...
	DMACH1BurstConfig(31,2,2);         //Will set up to use 32-bit datasize, pointers are based on 16-bit words 每个数据长32位,每个源/目的数据地址间隔位2因为一个DMABuf1/DMABuf2是16位长
