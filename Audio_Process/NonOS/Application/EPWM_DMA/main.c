 ...
 * 功能描述：
 *		EPWM触发DMA传输。（待测）
 *		本例程配置DMA通道1为ePWM1 SOCA触发，通道2为ePWM2 SOCB出发，通道3为ADC SEQ1INT
 *		触发，查看变量EPwm1Regs.TBPRD、EPwm1Regs.CMPA.all、ADCbuffer可观察数据传输情况。
 *
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 EPWM_DMA Demo application.\r\n\r\n", -1);
