...
/*
 * 功能描述：
 *     本例程通过查询方式实现MCBSP内部回环字符数据，用户可通过修改宏定义WORD_SIZE
 *  选择测试8位、16位、32位模式回环。
 *	   观察变量sdata1、rdata1、sdata2、rdata2、rdata1_point、rdata2_point可知数据回环
 *	情况。
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 MCBSP_LOOPBACK Demo application.\r\n\r\n", -1);
