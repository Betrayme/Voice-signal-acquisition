 ...
 * 功能描述：
 *		DMA方式存取ADC转换结果。
 *		ADC配置为4通道转换，DMA控制器在每个SEQ1_INT捕捉数据，并按照通道顺序重新排
 *		列数据，存入变量DMABuf1中，例如，通道A0的10个转换结果分别存入了DMABuf1【0】
 *		~DMABuf1【9】中。
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 ADC_DMA Demo application.\r\n\r\n", -1);
