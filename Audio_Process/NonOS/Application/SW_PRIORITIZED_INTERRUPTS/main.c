...
/*
 * 功能描述：
 *     本例程通过写PIEIFR寄存器模拟中断冲突，在同一时刻模拟多次中断进入PIE模块，
 * 通过由DSP2833x_SWPrioritizedIsrLevels.h文件建立的软件中断服务程序的优先级表来
 * 确定中断服务程序的优先级。用户可通过修改宏定义TEST来选择测试用例。
 * 	   查看变量ISRTrace可知各中断完成的次序。
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 SW_PRIORITIZED_INTERRUPTS Demo application.\r\n\r\n", -1);
