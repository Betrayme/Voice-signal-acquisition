...
#if (G11PL != 0)
__interrupt void SEQ1INT_ISR( void )     // ADC
{
...
#if (G12PL != 0)
__interrupt void SEQ2INT_ISR( void )    // ADC
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER1.all;
	IER |= M_INT1;
...
#if (G16PL != 0)
__interrupt void  ADCINT_ISR(void)     // ADC
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER1.all;
	IER |= M_INT1;
...
#if (G44PL != 0)
__interrupt void ECAP4_INT_ISR(void)     // eCAP4 Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER4.all;
	IER |= M_INT4;
...
#if (G44PL != 0)
__interrupt void ECAP5_INT_ISR(void)     // eCAP5 Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER4.all;
	IER |= M_INT4;
...
#if (G44PL != 0)
__interrupt void ECAP6_INT_ISR(void)     // eCAP6 Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER4.all;
	IER |= M_INT4;
...
#if (G63PL != 0)
__interrupt void MRINTB_ISR(void)    // McBSP-B
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER6.all;
	IER |= M_INT6;
...
#if (G64PL != 0)
__interrupt void MXINTB_ISR(void)     // McBSP-B
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER6.all;
	IER |= M_INT6;
...
#if (G97PL != 0)
__interrupt void ECAN0INTB_ISR(void)    // eCAN-B
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER9.all;
	IER |= M_INT9;
...
#if (G98PL != 0)
__interrupt void ECAN1INTB_ISR(void)     // eCAN-B
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER9.all;
	IER |= M_INT9;
...
#if (G122PL != 0)
__interrupt void XINT4_ISR(void)     // External Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G123PL != 0)
__interrupt void XINT5_ISR(void)     // External Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G124PL != 0)
__interrupt void XINT6_ISR(void)     // External Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G125PL != 0)
__interrupt void XINT7_ISR(void)    // External Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G127PL != 0)
__interrupt void LVF_ISR(void)    // FPA32
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
...
#if (G128PL != 0)
__interrupt void LUF_ISR(void)     // FPA32
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER12.all;
	IER |= M_INT12;
