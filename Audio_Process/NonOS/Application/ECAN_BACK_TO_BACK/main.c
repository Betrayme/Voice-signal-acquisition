...
/*
 * 功能描述：
 *     本例程演示CANB内部回环自测试，MBX0传送到MBX16，MBX1传送到MBX17依次类推。
 * 通信结果通过串口2打印。
 *
 */
...
// InitPeripherals(); // Not required for this example
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 ECAN Back To Back Demo application.\r\n\r\n", -1);
...
// Step 5. User specific code, enable interrupts:
    ...
    for(MessageReceivedCount=0; MessageReceivedCount<100; MessageReceivedCount++)
    {
