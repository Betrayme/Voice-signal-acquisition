...
/*
 * 功能描述：
 *     配置ePWM1~6的定时器产生中断，所有ePWM周期相同，ePWM1、ePWM4~6配置为一次事
 * 件产生一次中断，ePWM1配置为两次事件产生一次中断，ePWM3配置为三次事件产生一次中
 * 断，进入中断相应变量EPwmxTimerIntCount加1，比例约为3:2:1。
 *
 */
...
// This function is found in DSP2833x_PieVect.c.
   ...
   SCIStdioInit();
   SCIPuts("\r\n ============Test Start===========.\r\n", -1);
   SCIPuts("Welcome to TL28335 EPWM_TIMER_INTERRUPTS Demo application.\r\n\r\n", -1);
